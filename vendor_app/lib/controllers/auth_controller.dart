...
import 'package:vendor_app/views/auth/personal_details_screen.dart';
import 'package:vendor_app/views/auth/phone_auth_screen.dart';
import '../utils/toast_msg.dart';
import '../views/adminReview/admin_review_screen.dart';
import '../views/auth/otp_screen.dart';
import '../views/dashboardScreen/dash_board_scren.dart';
    ...
    try {
      ...
      if (user != null) {
        ...
        if (signInUser.additionalUserInfo!.isNewUser) {
          ...
          final doc =
              await FirebaseFirestore.instance.doc("Vendors/${user.uid}").get();
          if (doc.exists) {
